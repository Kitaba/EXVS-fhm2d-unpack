...
```text
D:\BaiduNetdiskDownload\ib1.0.4\EXVS_Texture_Toolkit
```
...
& 'C:\Users\hujinchang\AppData\Local\micromamba\micromamba.exe' run `
  -p 'D:\mambaenv\manga-translator' python <脚本和参数>
```
...
```powershell
Set-Location 'D:\BaiduNetdiskDownload\ib1.0.4\EXVS_Texture_Toolkit'
```
...
& 'C:\Users\hujinchang\AppData\Local\micromamba\micromamba.exe' run `
  -p 'D:\mambaenv\manga-translator' python `
  .\exvs_workflow.py inspect 'E:\work\0xFC492C9B' --package-name 0xFC492C9B
```
