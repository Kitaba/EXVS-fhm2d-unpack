...
```powershell
& 'C:\Users\hujinchang\AppData\Local\micromamba\micromamba.exe' run -p 'D:\mambaenv\manga-translator' python .\_internal\core\renderdoc_render_state_summarize.py
```
