...
Run in qrenderdoc with a capture open::
    ...
    exec(open(r"D:\BaiduNetdiskDownload\ib1.0.4\EXVS_Texture_Toolkit\机体结构贴图提取工程\_internal\renderdoc\exvs_auto_capture.py", encoding="utf-8").read())
"""
...
REUSE_SCAN = bool(_config.get("reuse_scan", True))
...
if REUSE_SCAN and os.path.isfile(saved_scan_manifest):
    print("EXVS auto capture phase 1/3: reusing existing scan {}".format(saved_scan_manifest))
else:
